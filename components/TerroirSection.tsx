...
const steps = [
  {
    ...
    title: "HAND-PICKED",
    description:
      "Each variety harvested at peak maturity by estate teams who've worked the same vines for generations. Several estates pick manually — so every bunch arrives whole, not bruised.",
  ...
  },
  {
    ...
    description:
      "Temperature-controlled from vineyard to your door in Vietnam. Not shaken. Not heat-damaged. Exactly as the winemaker intended — the kind of care most importers skip.",
