export default function Hero() {
  return (
    <section
      ...
      style={{
        backgroundImage: 'url(/images/categories/../lifestyle/vineyard-rows-aerial.webp)',
    ...
    >
      ...
      <div className='relative z-10 text-center px-6 max-w-4xl mx-auto'>
        ...
        <h1 className='font-display text-5xl md:text-7xl lg:text-8xl leading-tight text-[var(--off-white)] mb-6'>
          The French Wines<br />
          <span className='text-[var(--gold)]'>You Can't Find Anywhere Else in Vietnam</span>
        </h1>
        <p className='text-[var(--off-white)]/70 text-lg md:text-xl leading-relaxed max-w-2xl mx-auto mb-10'>
          Stop choosing between overpriced restaurant bottles and supermarket guesswork. We source directly from South of France estates — curated, cellar-quality wine, delivered to your door across Vietnam.
        </p>
      ...
      <div className='absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 opacity-50'>
        <span className='text-[var(--off-white)] text-xs tracking-widest uppercase'>Scroll</span>
