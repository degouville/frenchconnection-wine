const testimonials = [
  {
    quote:
      "Finally, wines I actually recognize. I've been ordering from FCW for months and the quality is consistently excellent — nothing like what you find in regular stores here.",
    author: "Sarah T.",
