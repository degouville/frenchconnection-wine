    ...
    <>
      ...
      <div ref={wrapperRef} id="smooth-wrapper">
        <div ref={contentRef} id="smooth-content">
          ...
          <section className="relative min-h-screen grid grid-cols-12 items-center overflow-hidden bg-(--ink)">
            ...
            <div className="col-start-1 col-end-7 row-start-1 h-[80vh] relative overflow-hidden">
              <div
                ...
                style={{
                  ...
                  height: "130%",
                  animation:
                    "clipInsetReveal 1.2s cubic-bezier(0.22, 1, 0.36, 1) 0.2s forwards",
                  clipPath: "inset(40% 40% 40% 40%)",
                }}
              >
                <Image
                  src="/images/lifestyle/vineyard-rows-aerial.webp"
                  alt="Vineyard rows aerial"
                  fill
                  sizes="50vw"
            ...
            <div className="col-start-5 col-end-13 row-start-1 h-[70vh] mt-20 relative overflow-hidden">
              <div
                ...
                style={{
                  ...
                  height: "130%",
                  animation:
                    "clipInsetReveal 1.2s cubic-bezier(0.22, 1, 0.36, 1) 0.6s forwards",
                  clipPath: "inset(40% 40% 40% 40%)",
                }}
              >
                <Image
                  src="/images/lifestyle/red-wine-pouring-decanter.webp"
                  alt="Red wine pouring"
                  fill
                  sizes="60vw"
                  className="object-cover"
                />
            ...
            <div className="col-start-1 col-end-13 row-start-1 z-10 flex items-center justify-center h-full px-6">
              ...
              >
                <h1
                  className="font-display text-6xl md:text-8xl lg:text-9xl leading-none text-(--off-white)"
                ...
                <p className="text-(--gold) text-xs tracking-[0.4em] uppercase mt-6">
                  Premium wines &middot; South of France &middot; Delivered to
                  Vietnam
                </p>
              </div>
            </div>
          ...
          <section className="py-24 px-6 bg-(--ink)">
            <div className="max-w-7xl mx-auto grid md:grid-cols-[2fr_1fr_1fr] gap-8 items-center">
              ...
              <div className="reveal relative h-[600px] overflow-hidden group">
                ...
                >
                  <Image
                    ...
                    onMouseLeave={(e) => {
                      (e.target as HTMLElement).style.clipPath = "inset(3%)";
                    }}
                  />
                </div>
                <div className="absolute inset-0 border-2 border-(--gold)/30 pointer-events-none z-10" />
              </div>

              {/* Floating bottle */}
              <div
                className="reveal flex flex-col items-center md:-mt-20"
                data-speed="1.05"
              >
                <div
                ...
                >
                  <Image
                    ...
                    alt="Forge Celeste 2019"
                    width={140}
                    height={420}
                    className="object-contain drop-shadow-2xl"
                  />
                </div>
                <p className="font-display text-(--off-white) text-xl mt-6">
                  Forge Celeste
                </p>
              ...
              <div className="reveal text-center md:text-left">
                <p className="font-display text-(--gold) text-7xl md:text-8xl leading-none">
                  2.5M
                </p>
                <p className="text-(--off-white)/50 text-xs tracking-widest uppercase mt-2">
                  VND per bottle
                </p>
                <a
                  href="https://zalo.me/84936480805"
                  className="inline-block mt-8 px-8 py-3.5 bg-(--gold) text-(--ink) font-bold text-sm tracking-widest uppercase hover:bg-(--gold-dk) transition-colors"
                >
                  Order Now
                </a>
              </div>
          ...
          <section className="terroir-parallax relative h-[60vh] flex items-center justify-center overflow-hidden">
            ...
            <h2
              className="terroir-giant relative z-10 font-display text-[20vw] leading-none text-(--off-white) select-none"
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="brutalist-grid grid md:grid-cols-3 gap-8 md:gap-6">
                {terroirCards.map((card, i) => (
                  <div
                    key={card.number}
                    className="brutalist-card relative border-2 border-(--gold)/30 overflow-hidden"
                    style={{
                  ...
                  >
                    <div className="relative h-64 overflow-hidden">
                      ...
                      >
                        <Image
                          ...
                          onMouseEnter={(e) => {
                            (e.target as HTMLElement).style.clipPath =
                              "inset(0%)";
                          }}
                          onMouseLeave={(e) => {
                            (e.target as HTMLElement).style.clipPath =
                    ...
                    <p className="font-display text-(--gold)/15 text-9xl leading-none absolute -top-4 -left-2 pointer-events-none select-none">
                      {card.number}
                    </p>
                    <div className="p-8">
                      <h3 className="font-display text-xl text-(--off-white) mb-3">
                        {card.title}
                      </h3>
          ...
          <section className="quote-section relative py-32 px-6 overflow-hidden">
            ...
            <div className="quote-box relative z-10 max-w-3xl ml-[5%] md:ml-[10%] bg-(--off-white) p-10 md:p-16 -mb-20">
              <p className="font-display text-(--bordeaux) text-4xl leading-none mb-6">
                &ldquo;
              </p>
              <blockquote className="font-display text-2xl md:text-3xl italic text-(--ink) leading-relaxed mb-6">
                Every bottle we ship is one we would pour at our own table
                first.
              </blockquote>
              <p className="text-(--ink-mid) text-xs tracking-[0.3em] uppercase">
                &mdash; French Connection Wines
              </p>
            </div>
          </section>
