...
const galleryImages = [
  { src: '/images/lifestyle/vineyard-rows-aerial.webp', alt: 'Vineyard rows aerial view' },
  { src: '/images/lifestyle/harvest-pruning-white-grapes.webp', alt: 'Pruning white grapes' },
  { src: '/images/lifestyle/red-wine-pouring-decanter.webp', alt: 'Pouring red wine' },
  { src: '/images/lifestyle/hands-holding-red-grapes.webp', alt: 'Hands holding grapes' },
  { src: '/images/lifestyle/harvest-white-grapes-basket.webp', alt: 'Grapes in basket' },
  { src: '/images/lifestyle/wine-glasses-rose-red-overhead.webp', alt: 'Wine glasses overhead' },
]

const featureBottles = [
  { src: '/images/bottles/forge-celeste-2019-saint-emilion-grand-cru.png', name: 'Forge Celeste' },
  { src: '/images/bottles/chateau-pennautier.png', name: 'Chateau Pennautier' },
  { src: '/images/bottles/chateau-fontanche-red.png', name: 'Chateau Fontanche' },
]
      ...
      <div ref={wrapperRef} id='smooth-wrapper'>
        <div ref={contentRef} id='smooth-content'>
          ...
          <section className='relative min-h-screen grid grid-cols-1 md:grid-cols-2'>
            {/* Left: Copy */}
            <div className='flex flex-col justify-center px-8 md:px-16 py-32 md:py-0 bg-[var(--ink)] z-10'>
              <p className='text-[var(--gold)] text-xs tracking-[0.3em] uppercase mb-6'>CENTRAL VIETNAM</p>
              <h1 className='font-display text-5xl md:text-6xl lg:text-7xl leading-tight text-[var(--off-white)] mb-6'>
                The French Wines<br />
                <span className='text-[var(--gold)]'>You Deserve</span>
              </h1>
              <p className='text-[var(--off-white)]/70 text-lg leading-relaxed max-w-md mb-10'>
                Sourced directly from South of France estates. Curated, cellar-quality wine, delivered to your door.
              </p>
              <div className='flex flex-wrap gap-4'>
                <a href='#wines' className='px-8 py-3.5 bg-[var(--gold)] text-[var(--ink)] font-bold text-sm tracking-widest uppercase hover:bg-[var(--gold-dk)] transition-colors'>
                  Browse Collection
                </a>
                <a href='https://zalo.me/84936480805' className='px-8 py-3.5 border border-[var(--off-white)]/40 text-[var(--off-white)] text-sm tracking-widest uppercase hover:border-[var(--gold)] hover:text-[var(--gold)] transition-colors'>
                  Order on Zalo
                </a>
              </div>
            </div>
            ...
            <div className='relative min-h-[50vh] md:min-h-0 overflow-hidden'>
              ...
              >
                <div
                  ...
                  style={{
                    backgroundImage: 'url(/images/lifestyle/vineyard-rows-aerial.webp)',
                    backgroundSize: 'cover',
                    backgroundPosition: 'center',
                    animation: 'clipDiagonal 1.4s cubic-bezier(0.22, 1, 0.36, 1) forwards',
                    clipPath: 'polygon(30% 0, 30% 0, 30% 100%, 30% 100%)',
                  }}
                />
              </div>
              <div className='absolute inset-0 bg-[var(--ink)]/20 z-10' />
            </div>
          ...
          <section className='py-24 px-6 bg-[var(--ink)]'>
            <div className='max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center'>
              ...
              {/* Left: Parallelogram image — oversized for parallax */}
              <div
              ...
              <div className='reveal'>
                <p className='text-[var(--gold)] text-xs tracking-[0.3em] uppercase mb-3'>THE COLLECTION</p>
                <h2 className='font-display text-4xl md:text-5xl text-[var(--off-white)] mb-6'>Wines With Character</h2>
                <p className='text-[var(--off-white)]/70 leading-relaxed mb-10 max-w-md'>
                  From the sun-drenched vineyards of Languedoc to the prestigious terroirs of Saint-Emilion. Every bottle tells the story of its origin.
                </p>
                <div className='flex gap-6'>
                  {featureBottles.map(b => (
                    <div key={b.name} className='text-center'>
                      <div className='h-48 flex items-end justify-center mb-3'>
                        <Image src={b.src} alt={b.name} width={60} height={180} className='object-contain drop-shadow-lg' />
                      </div>
                      <p className='text-[var(--off-white)]/60 text-xs tracking-wide'>{b.name}</p>
                    </div>
                  ))}
                </div>
              </div>
          ...
          <section className='relative h-[60vh] flex items-center justify-center overflow-hidden'>
            ...
            <div className='relative z-10 text-center px-6 max-w-3xl reveal'>
              <p className='font-display text-3xl md:text-4xl italic text-[var(--off-white)] leading-relaxed'>
                &ldquo;Wine is sunlight, held together by water.&rdquo;
              </p>
              <p className='text-[var(--gold)] text-xs tracking-[0.3em] uppercase mt-6'>&mdash; Galileo Galilei</p>
            </div>
          </section>
          ...
          <section className='py-24 bg-[var(--ink)]'>
            <div className='max-w-7xl mx-auto px-6 mb-12 reveal'>
              <p className='text-[var(--gold)] text-xs tracking-[0.3em] uppercase mb-3'>GALLERY</p>
              <h2 className='font-display text-4xl md:text-5xl text-[var(--off-white)]'>Life in the Vineyard</h2>
            </div>
            <div
