...
const mosaicBottles = [
  ...
  { src: '/images/bottles/camas-cremant-de-limoux.png', name: 'Cremant de Limoux' },
]
        ...
        <div ref={contentRef} id='smooth-content'>
          ...
          <section className='relative min-h-screen flex items-center justify-center overflow-hidden'>
            <div
              ...
              style={{
                ...
                animation: 'clipCircleExpand 1.8s cubic-bezier(0.22, 1, 0.36, 1) forwards',
            ...
            >
              ...
              <h1 className='font-display text-5xl md:text-7xl lg:text-8xl leading-tight text-[var(--off-white)] mb-6'>
                Experience French Wine<br />
                <span className='text-[var(--gold)]'>Like Never Before</span>
              </h1>
              <p className='text-[var(--off-white)]/70 text-lg md:text-xl leading-relaxed max-w-2xl mx-auto mb-10'>
                Direct from estate to your table. Premium South of France wines, curated for discerning palates in Vietnam.
              </p>
          ...
          <section className='relative bg-[var(--ink)]'>
            <div className='grid md:grid-cols-2 min-h-[300vh]'>
              ...
              <div className='hidden md:block relative'>
                <div className='sticky top-0 h-screen overflow-hidden'>
                  <div className='absolute inset-0 bg-[var(--bordeaux)]' />
                  <div
                    className='img-parallax-wrap absolute inset-x-0 w-full'
              ...
              <div className='flex flex-col'>
                {terroirSteps.map((step) => (
                  <div key={step.number} className='min-h-screen flex items-center px-8 md:px-16'>
                    <div className='reveal'>
                      <p className='step-number font-display text-[var(--gold)]/20 text-9xl leading-none mb-4'>{step.number}</p>
                      <h3 className='font-display text-3xl md:text-4xl text-[var(--off-white)] mb-6'>{step.title}</h3>
                      <p className='text-[var(--off-white)]/70 leading-relaxed max-w-md text-lg'>{step.desc}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className='md:hidden relative h-[50vh] overflow-hidden'>
              ...
              <div className='absolute inset-0 bg-[var(--bordeaux)]/40' />
            </div>
          </section>
          ...
          <section className='py-24 px-6 bg-[var(--ink)]'>
            <div className='max-w-7xl mx-auto'>
              <div className='text-center mb-16 reveal'>
                ...
                <h2 className='font-display text-4xl md:text-5xl text-[var(--off-white)]'>Our Finest Selection</h2>
              ...
              <div className='grid grid-cols-2 md:grid-cols-3 gap-8'>
                {mosaicBottles.map((b) => (
                  <div key={b.name} className='flex flex-col items-center'>
                    <div
                      className='mosaic-item h-64 w-full flex items-center justify-center bg-[var(--ink-mid)]/20'
                      style={{ clipPath: 'circle(0%)', transition: 'clip-path 0.7s ease' }}
                    >
                      <Image src={b.src} alt={b.name} width={80} height={240} className='object-contain drop-shadow-xl' />
                    </div>
                    <p className='text-[var(--off-white)]/70 text-sm mt-4 tracking-wide'>{b.name}</p>
                  </div>
                ))}
              </div>
            </div>
          ...
          <section className='relative h-[70vh] flex items-center justify-center overflow-hidden'>
            <div
              ...
              style={{
                top: '-15%',
                height: '130%',
                backgroundImage: 'url(/images/lifestyle/wine-glasses-rose-red-overhead.webp)',
                backgroundSize: 'cover',
                backgroundPosition: 'center',
              }}
            />
            <div className='absolute inset-0 bg-[var(--bordeaux)]' style={{ mixBlendMode: 'multiply' }} />
            <div className='relative z-10 text-center px-6 reveal'>
              <h2 className='font-display text-5xl md:text-7xl text-[var(--off-white)] mb-4'>
                Taste the Difference
              </h2>
              <p className='text-[var(--off-white)]/70 text-lg max-w-xl mx-auto mb-8'>
